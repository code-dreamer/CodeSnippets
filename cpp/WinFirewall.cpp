...
FW_ERROR_CODE WinFirewall::Initialize()
{
	HRESULT hr = S_FALSE;
...
FW_ERROR_CODE WinFirewall::Uninitialize()
{
...
FW_ERROR_CODE WinFirewall::IsWindowsFirewallOn( BOOL& bOn )
{
	HRESULT hr;
...
FW_ERROR_CODE WinFirewall::TurnOnWindowsFirewall()
{
	HRESULT hr;
...
FW_ERROR_CODE WinFirewall::TurnOffWindowsFirewall()
{
	HRESULT hr;
	try
	{
...
FW_ERROR_CODE WinFirewall::IsAppEnabled( const wchar_t* lpszProcessImageFileName, BOOL& bEnable )
{
	FW_ERROR_CODE ret = FW_NOERROR;
	HRESULT hr;
...
FW_ERROR_CODE WinFirewall::IsPortEnabled( LONG lPortNumber, NET_FW_IP_PROTOCOL ipProtocol, BOOL& bEnable )
{
	FW_ERROR_CODE ret = FW_NOERROR;
	VARIANT_BOOL bFWEnabled;
...
FW_ERROR_CODE WinFirewall::AddPort( LONG lPortNumber, NET_FW_IP_PROTOCOL ipProtocol, const wchar_t* lpszRegisterName )
{
	FW_ERROR_CODE ret = FW_NOERROR;
	INetFwOpenPort* pFWOpenPort = NULL;
	INetFwOpenPorts* pFWOpenPorts = NULL;
...
FW_ERROR_CODE WinFirewall::RemovePort( LONG lPortNumber, NET_FW_IP_PROTOCOL ipProtocol )
{
	FW_ERROR_CODE ret = FW_NOERROR;
	INetFwOpenPorts* pFWOpenPorts = NULL;
	HRESULT hr;
